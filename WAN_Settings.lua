...
local function OnEvent(self, event, addonname)
    if addonname == "WhackANiffen" then
        ...
        do -- toggle to switch between updating on a tick timer or every frame with throttling, unlock update rate slider
            ...
            local function IsParentSelectedC3() return settingUpdateRateToggle:GetValue() end
            ...
            do -- slider that set the throttle timer while its updating on every frame
                ...
                initUpdateRateSlider:SetParentInitializer(initUpdateRateToggle, IsParentSelectedC3)
            end
        end
        ...
        do -- toggle for the damage frame to enable dragging and enable further customization
            ...
            local initDamageToggle = Settings.CreateCheckbox(category, settingDamageToggle, tooltipDamageToggle)
            ...
            do
                ...
                local initDamageAlphaSlider = Settings.CreateSlider(category, settingDamageAlphaSlider, optionsDamageAlphaSlider, tooltipDamageAlphaSlider)
            ...
            do
                ...
                local initDamageHorizontalPosition = Settings.CreateSlider(category, settingDamageHorizontalPosition, optionsDamageHorizontalPosition, tooltipDamageHorizontalPosition)
            ...
            do
                ...
                local initDamageVerticalPosition = Settings.CreateSlider(category, settingDamageVerticalPosition, optionsDamageVerticalPosition, tooltipDamageVerticalPosition)
            ...
            do
                ...
                local initDamageCombatAlphaSlider = Settings.CreateSlider(category, settingDamageCombatAlphaSlider, optionsDamageCombatAlphaSlider, tooltipDamageCombatAlphaSlider)
        ...
        do
            ...
            local initMechanicToggle = Settings.CreateCheckbox(category, settingMechanicToggle, tooltipMechanicToggle)
            ...
            do
                ...
                local initMechanicAlphaSlider = Settings.CreateSlider(category, settingMechanicAlphaSlider, optionsMechanicAlphaSlider, tooltipMechanicAlphaSlider)
            ...
            do
                ...
                local initMechanicHorizontalPosition = Settings.CreateSlider(category, settingMechanicHorizontalPosition, optionsMechanicHorizontalPosition, tooltipMechanicHorizontalPosition)
            ...
            do
                ...
                local initMechanicVerticalPosition = Settings.CreateSlider(category, settingMechanicVerticalPosition, optionsMechanicVerticalPosition, tooltipMechanicVerticalPosition)
            ...
            do
                ...
                local initMechanicCombatAlphaSlider = Settings.CreateSlider(category, settingMechanicCombatAlphaSlider, optionsMechanicCombatAlphaSlider, tooltipMechanicCombatAlphaSlider)
        ...
        do -- toggle for the heal frame to enable dragging and enable further customization
            ...
            local initHealToggle = Settings.CreateCheckbox(category, settingHealToggle, tooltipHealToggle)
            ...
            do
                ...
                local initHealAlphaSlider = Settings.CreateSlider(category, settingHealAlphaSlider, optionsHealAlphaSlider, tooltipHealAlphaSlider)
            ...
            do
                ...
                local initHealHorizontalPosition = Settings.CreateSlider(category, settingHealHorizontalPosition, optionsHealHorizontalPosition, tooltipHealHorizontalPosition)
            ...
            do
                ...
                local initHealVerticalPosition = Settings.CreateSlider(category, settingHealVerticalPosition, optionsHealVerticalPosition, tooltipHealVerticalPosition)
            ...
            do
                ...
                local initHealCombatAlphaSlider = Settings.CreateSlider(category, settingHealCombatAlphaSlider, optionsHealCombatAlphaSlider, tooltipHealCombatAlphaSlider)
